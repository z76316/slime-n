...
MULTI_AGENT_CONFIGS = {
    "custom_multi_agent_function_path": "examples.multi_policy_shared_state.agent_system.run_agent_system",
    "num_parallel": 4,
    "outer_group_size": 1,
}
...
async def generate_with_shared_state(args, sample: Sample, sampling_params, evaluation=False) -> list[Sample]:
