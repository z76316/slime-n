...
MULTI_AGENT_CONFIGS = {
    "custom_multi_agent_function_path": "examples.multi_policy_generator_verifier.agent_system.run_agent_system",
    "num_parallel": 8,
    "outer_group_size": 1,
}
...
async def generate_with_verifier(args, sample: Sample, sampling_params, evaluation=False) -> list[Sample]:
