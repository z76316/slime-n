...
def parse_args():
    ...
    parser.add_argument("--model_id", type=str, required=True, help="local BF16 path")
    parser.add_argument("--output_dir", type=str, required=True)
    parser.add_argument("--local_data_path", type=str, required=True,
                        help="dataset path")
    parser.add_argument("--quant_type", type=str, choices=["W4A16", "W8A16"], default="W4A16")
    parser.add_argument("--num_calibration_samples", type=int, default=256, help="sample nums")
    ...
    parser.add_argument("--quant_group_size", type=int, default=32, help="GPTQ Group Size")
...
def get_calibration_dataset(tokenizer, num_samples, seq_len, local_data_path):
    ...
    for _ in range(num_samples):
        ...
        data_list.append({
            ...
            "attention_mask": torch.ones_like(chunk).tolist()
        })
